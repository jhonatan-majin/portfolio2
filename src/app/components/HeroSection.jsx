...
const HeroSection = () => {
  ...
  return (
    <section className="lg:py-16">
      {data.map((heroData) => (
        <div key={heroData._id} className="grid grid-cols-1 sm:grid-cols-12">
          <motion.div
            ...
            <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
              ...
              <TypeAnimation
                sequence={[
                  "Jhonatan Majin",
                  1000,
                  heroData.title0 || "Developer",
                  1000,
                  heroData.title1 || "Designer",
                  1000,
                  heroData.title2 || "Creator",
                  1000,
                ]}
                wrapper="span"
                speed={50}
          ...
          >
            <div className="rounded-full bg-[#181818] w-[150px] h-[250px] lg:w-[400px] lg:h-[400px] relative overflow-hidden">
              <Image
